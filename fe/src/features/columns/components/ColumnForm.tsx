  ...
  if (!isEditMode && !isShowing) {
    return (
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 text-base text-gray-400 border-2 border-dashed border-gray-300 rounded-lg hover:bg-gray-100 transition w-[280px] shrink-0 justify-center"
      >
